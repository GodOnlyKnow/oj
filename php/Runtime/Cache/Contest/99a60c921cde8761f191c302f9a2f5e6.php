	...
	<a id="Brand" href="#">
        ...
        <div id="contest-info" style="width: 80%;height: 500px;background: #e0dede; left:50%;margin-left: -40%; border-radius: 20px 20px 0 0;position: absolute;top: 150px">
            <ul class="nav nav-tabs " role="tablist" style="margin: 5px 0 0 5px;">
              ...
              <li role="presentation" class="active"><a href='#'>Report<span class="badge"></span></a></li>
            ...
            <div style="width: 90%;margin: 0 auto;">
                <?php if(is_array($news)): foreach($news as $key=>$v): ?><h2 style="color: rgb(44,122,180)"><?php echo ($v['title']); ?></h2>
                <div style="">
                  <span style="color:#4EA1F4">Last modified at:</span><span style="color: #131415"><?php echo ($v['last_time']); ?></span>
                </div>
                <div style="background: #fff;border-radius: 10px;padding: 5px;">
                    <label><?php echo ($v['context']); ?></label>
                </div><?php endforeach; endif; ?>
                <?php if(empty($news))echo'
                <div style="margin-top: 10px" class="alert alert-info" role="alert">No news in this contest</div>
                ';?>
            </div>
        </div>
    </body>
